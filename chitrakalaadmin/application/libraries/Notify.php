...
class Notify {
    ...
    public function sendNotification($gcm_id, $message,$type,$image)
    {
        ...
        $headers = array
        (
            'Authorization: key=AAAAy29y2k8:APA91bGjJvqq9JVZqq1oeIqpFuInyAp1EXotWLdjCYH-XrG27Hby5ZDtPVDxQBqrrxeiwE-6rMOpfcfMjHAn47K7N7hTLj8xEbX3ecfzWEZRnBrlLIUENQ6I5Ukp3_UZQe6kDiGlXiRD',
